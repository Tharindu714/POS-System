...
public class home extends javax.swing.JFrame {
    ...
    public home(String email, String name) {
        initComponents();
        jTextField1.setText(name);
        jLabel7.setText(String.valueOf(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date())));
        dateTime();
        ImageIcon imageIcon = new ImageIcon(home.class.getResource("/img/logo-1.png"));
    ...
    public void dateTime() {
        ...
        time = new Timer(0, new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                jLabel8.setText(String.valueOf(new SimpleDateFormat("yyyy.MMM.dd | HH:mm:ss a").format(new Date())));
            }
        });
        time.start();
    }
    ...
    private void initComponents() {
        ...
        jMenuItem5.setForeground(new java.awt.Color(51, 255, 255));
        jMenuItem5.setText("Stock table");
        ...
        jLabel1.setText("Logged User Details");
        ...
        jButton3.setText("Back To Sign In");
        ...
        jPanel2.setPreferredSize(new java.awt.Dimension(197, 381));
        jPanel2.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/side.jpg"))); // NOI18N
        jPanel2.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, -1));

        jPanel3.setPreferredSize(new java.awt.Dimension(1000, 119));
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/header.jpg"))); // NOI18N
        jPanel3.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, -1));

        jButton1.setFont(new java.awt.Font("Segoe UI Semibold", 1, 14)); // NOI18N
        jButton1.setForeground(new java.awt.Color(255, 255, 255));
        jButton1.setText("Resgister New Customer");
        ...
        jButton2.setText("Accept a New Repair");
        ...
        jButton4.setText("Accept Product History");
        ...
        jButton5.setText("Issue a New Invoice");
        ...
        jButton6.setText("Invoice History");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jButton1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 239, Short.MAX_VALUE)
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here
        accept_table act = new accept_table();
        act.setVisible(true);
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
        accept_tableHistory acc_history = new accept_tableHistory();
        acc_history.setVisible(true);
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        // TODO add your handling code here:
        Invoice_history in_history = new Invoice_history();
        in_history.setVisible(true);
